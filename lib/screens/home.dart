          ...
          (
            ...
            (
                      ...
                      (
                        onTap: () async {
                          try {
                            ...
                            var url = await StorageRepo().getUserProfileImage(Provider.of<UserProvider>(context,listen: false).getUser.uid);
                            setState(() {
              ...
              ListTile(
                ...
                onTap: () {
                  signOut();
                  Provider.of<UserProvider>(context, listen: false).destroyUser();
                  Navigator.pushReplacement(
